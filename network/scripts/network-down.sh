...
docker stop chaincode-basic backend prometheus grafana elasticsearch logstash kibana filebeat 2>/dev/null || true
docker rm chaincode-basic backend prometheus grafana elasticsearch logstash kibana filebeat 2>/dev/null || true
